...
export type MessageComponent = ActionRow | Button | StringSelect | UserSelect | RoleSelect | MentionableSelect | ChannelSelect | TextInput | Section | TextDisplay | Thumbnail | MediaGallery | FileComponent | Separator | Container | Label;
...
export type ActionRow = BaseComponent & {
    ...
    components: Array<Button | StringSelect | UserSelect | RoleSelect | MentionableSelect | ChannelSelect | TextInput>;
};
